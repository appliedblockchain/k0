...
// page 58
void k0::clamp_curve25519(unsigned char key[32]) {
    key[0] &= 248;
    key[31] &= 127;
    key[31] |= 64;
}

void k0::ka_format_private(unsigned char key[32]) {
    k0::clamp_curve25519(key);
}

void k0::ka_derive_public(unsigned char pk[32],
...
void k0::ka_agree(unsigned char dhsecret[32], const unsigned char priv[32],
