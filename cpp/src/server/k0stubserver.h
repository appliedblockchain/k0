...
#ifndef JSONRPC_CPP_STUB_K0STUBSERVER_H_
#define JSONRPC_CPP_STUB_K0STUBSERVER_H_

#include <jsonrpccpp/server.h>

class K0StubServer : public jsonrpc::AbstractServer<K0StubServer>
{
    public:
        K0StubServer(jsonrpc::AbstractServerConnector &conn, jsonrpc::serverVersion_t type = jsonrpc::JSONRPC_SERVER_V2) : jsonrpc::AbstractServer<K0StubServer>(conn, type)
        {
            this->bindAndAddMethod(jsonrpc::Procedure("add", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param01",jsonrpc::JSON_STRING, NULL), &K0StubServer::addI);
            this->bindAndAddMethod(jsonrpc::Procedure("cm", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING, "param01",jsonrpc::JSON_STRING,"param02",jsonrpc::JSON_STRING,"param03",jsonrpc::JSON_STRING,"param04",jsonrpc::JSON_STRING, NULL), &K0StubServer::cmI);
            this->bindAndAddMethod(jsonrpc::Procedure("decrypt_note", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param01",jsonrpc::JSON_STRING,"param02",jsonrpc::JSON_STRING,"param03",jsonrpc::JSON_STRING, NULL), &K0StubServer::decrypt_noteI);
            this->bindAndAddMethod(jsonrpc::Procedure("deriveKeys", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param01",jsonrpc::JSON_STRING, NULL), &K0StubServer::deriveKeysI);
            this->bindAndAddMethod(jsonrpc::Procedure("element", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING, "param01",jsonrpc::JSON_INTEGER, NULL), &K0StubServer::elementI);
            this->bindAndAddMethod(jsonrpc::Procedure("encrypt_note", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING, "param01",jsonrpc::JSON_STRING,"param02",jsonrpc::JSON_STRING, NULL), &K0StubServer::encrypt_noteI);
            this->bindAndAddMethod(jsonrpc::Procedure("exampleWitnessAndProof", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param01",jsonrpc::JSON_STRING, NULL), &K0StubServer::exampleWitnessAndProofI);
            this->bindAndAddMethod(jsonrpc::Procedure("hash", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING, "param01",jsonrpc::JSON_STRING,"param02",jsonrpc::JSON_STRING, NULL), &K0StubServer::hashI);
            this->bindAndAddMethod(jsonrpc::Procedure("depositCommitmentProof", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param01",jsonrpc::JSON_STRING,"param02",jsonrpc::JSON_STRING,"param03",jsonrpc::JSON_STRING,"param04",jsonrpc::JSON_STRING, NULL), &K0StubServer::depositCommitmentProofI);
            this->bindAndAddMethod(jsonrpc::Procedure("merkleTreeAdditionProof", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_ARRAY, "param01",jsonrpc::JSON_STRING,"param02",jsonrpc::JSON_STRING,"param03",jsonrpc::JSON_STRING,"param04",jsonrpc::JSON_ARRAY,"param05",jsonrpc::JSON_STRING, NULL), &K0StubServer::merkleTreeAdditionProofI);
            this->bindAndAddMethod(jsonrpc::Procedure("prepareTransfer", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param01",jsonrpc::JSON_STRING,"param02",jsonrpc::JSON_STRING,"param03",jsonrpc::JSON_STRING,"param04",jsonrpc::JSON_STRING,"param05",jsonrpc::JSON_STRING,"param06",jsonrpc::JSON_STRING,"param07",jsonrpc::JSON_ARRAY,"param08",jsonrpc::JSON_STRING,"param09",jsonrpc::JSON_STRING,"param10",jsonrpc::JSON_STRING,"param11",jsonrpc::JSON_STRING,"param12",jsonrpc::JSON_STRING,"param13",jsonrpc::JSON_ARRAY,"param14",jsonrpc::JSON_STRING,"param15",jsonrpc::JSON_STRING,"param16",jsonrpc::JSON_STRING,"param17",jsonrpc::JSON_STRING,"param18",jsonrpc::JSON_STRING,"param19",jsonrpc::JSON_STRING,"param20",jsonrpc::JSON_STRING,"param21",jsonrpc::JSON_STRING,"param22",jsonrpc::JSON_STRING, NULL), &K0StubServer::prepareTransferI);
            this->bindAndAddMethod(jsonrpc::Procedure("prepare_withdrawal", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param01",jsonrpc::JSON_STRING,"param02",jsonrpc::JSON_STRING,"param03",jsonrpc::JSON_STRING,"param04",jsonrpc::JSON_STRING,"param05",jsonrpc::JSON_STRING,"param06",jsonrpc::JSON_STRING, NULL), &K0StubServer::prepare_withdrawalI);
            this->bindAndAddMethod(jsonrpc::Procedure("pack256Bits", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_ARRAY, "param01",jsonrpc::JSON_STRING, NULL), &K0StubServer::pack256BitsI);
            this->bindAndAddMethod(jsonrpc::Procedure("prf_addr", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING, "param01",jsonrpc::JSON_STRING, NULL), &K0StubServer::prf_addrI);
            this->bindAndAddMethod(jsonrpc::Procedure("reset", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING,  NULL), &K0StubServer::resetI);
            this->bindAndAddMethod(jsonrpc::Procedure("root", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING,  NULL), &K0StubServer::rootI);
            this->bindAndAddMethod(jsonrpc::Procedure("status", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,  NULL), &K0StubServer::statusI);
            this->bindAndAddMethod(jsonrpc::Procedure("unpack256Bits", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING, "param01",jsonrpc::JSON_STRING,"param02",jsonrpc::JSON_STRING, NULL), &K0StubServer::unpack256BitsI);
            this->bindAndAddMethod(jsonrpc::Procedure("verifyProof", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_BOOLEAN, "param01",jsonrpc::JSON_STRING,"param02",jsonrpc::JSON_OBJECT,"param03",jsonrpc::JSON_ARRAY, NULL), &K0StubServer::verifyProofI);
        }
...
#endif //JSONRPC_CPP_STUB_K0STUBSERVER_H_
